...
function BlogHeadline() {
  ...
  return (
    ...
    <div className="blog-headline jumbotron jumbotron-fluid pt-3 pb-3">
        ...
        <img src="https://d2l0wy9lsui5uy.cloudfront.net/c/u/f67894297b6134a6b759b3a9ec15b6cb/2020/08/30050033/Hatha-Yoga-Practice.jpg" className="img-fluid cover-img" alt="yoga-cover"/>
