  ...
  return (
    <div>
      <a
        ...
        className={
          "nav-link module " +
          (props.module.id === "module_1" ? "active navArrowTransition" : "")
        }
      ...
      >
        <img
          className="dropdownNavArrow navArrowTransition"
          src={"/images/ClassRoom/hideNavArrow.png"}
          alt="..."
        />{" "}
        <span className="text-muted v-nav-moduleID">
          {"Módulo " + props.module.id.slice(-1)}:{" "}
        </span>
