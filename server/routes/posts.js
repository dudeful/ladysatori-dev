...
router.route("/admin/new-post").post(rateLimiter.addPostSpeedLimiter, rateLimiter.addPostLimiter, (req, res) => {
...
router
  .route("/update-post/:id/:title")
  .patch(rateLimiter.addPostSpeedLimiter, rateLimiter.addPostLimiter, (req, res) => {
    const bodyBlocks = req.body.body.blocks;
...
router.route("/delete-post/:id").delete(rateLimiter.addPostSpeedLimiter, rateLimiter.addPostLimiter, (req, res) => {
